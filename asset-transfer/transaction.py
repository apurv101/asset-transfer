...
class Transaction(object):
    ...
    def __init__(self, source, destination, amount, asset, signature):
        self.source = source
...
class Transaction_property(object):

    def __init__(self, source, destination, amount, location, registry, asset, signature):
        self.source = source
        self.destination = destination
        self.amount = amount
        self.location = location
        sef.registry = registry
        self.timestamp = datetime.datetime.utcnow().isoformat()
        self.signature = signature
        self.tx_hash = self.calculate_tx_hash()
